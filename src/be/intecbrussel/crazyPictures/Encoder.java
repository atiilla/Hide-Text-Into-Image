...
public class Encoder {
	...
	public BufferedImage hideString(String s) throws IOException {
		...
		BufferedImage secretImage = new BufferedImage(this.img.getWidth(), this.img.getHeight(),
				BufferedImage.TYPE_3BYTE_BGR);
		secretImage.setData(Raster.createRaster(secretImage.getSampleModel(),
				new DataBufferByte(ie.getImg(), ie.getImg().length), new Point()));
		return secretImage;
	}
